...
\texttt{.ctors}\todo{should probably describe these sections
in detail}-sections upon printing assembly for the given platform.
With \bjoern{language like this OK?}nothing for the linker to pick up in the
